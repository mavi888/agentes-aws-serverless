...
# --- NUEVO: Modelo Pydantic para tickets ---
...
# --- NUEVO: Función para generar ticket ---
def crear_ticket(conversacion: str) -> SupportTicket:
...
def main():
    ...
    while True:
        ...
        if user_input.lower() in ["salir", "exit", "quit"]:
            # Generar ticket antes de salir si hubo conversación
